...
const ProgressDial = (props) => {
  ...
  const rangeArray = [0, parseFloat(userData.weekTarget/3).toFixed(2), parseFloat((userData.weekTarget/3)*2).toFixed(2), userData.weekTarget];
  const chartData = [
